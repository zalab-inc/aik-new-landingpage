    ...
    return (
        <section className="py-24 bg-eduzin-dark text-white relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">Ready to upgrade your research?</h2>
                <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto">
                    Join 1,200+ students who have transformed their academic writing process. Enroll today and get full access to Scite premium features for the duration of the course.
                </p>
