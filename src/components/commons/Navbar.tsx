        ...
        <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-[#EAE7E0]/90 dark:bg-[#18181B]/90 backdrop-blur-md shadow-sm border-b border-[#234238]/10 dark:border-white/10 ${scrolled ? 'py-4' : 'py-6'}`}>
            <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    <a href="/blogs" className="hover:opacity-75 transition-opacity cursor-pointer">BLOG</a>
                    <a href="/faq" className="hover:opacity-75 transition-opacity cursor-pointer">FAQ</a>
            ...
            {mobileMenuOpen && (
                <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-lg py-8 px-4 flex flex-col gap-4 text-center">
                    ...
                    <a href="/schedule" className="text-gray-800 font-medium cursor-pointer" onClick={() => setMobileMenuOpen(false)}>Schedule</a>
                    <a href="/blogs" className="text-gray-800 font-medium cursor-pointer" onClick={() => setMobileMenuOpen(false)}>Blog</a>
                    <a href="/faq" className="text-gray-800 font-medium cursor-pointer" onClick={() => setMobileMenuOpen(false)}>FAQ</a>
